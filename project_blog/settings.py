...
SECRET_KEY = '%=$38m!@p$5$q31_h$kjbhnn#god&9kwjw@jd=+a&jg5dnn_db'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'localhost ', '.myoak.info']
...
ADMINS = (('MYOAK', 'sunzhesz@yahoo.com'),)

SEND_NOTIFICATION_EMAIL = True   # 开启邮件通知

EMAIL_HOST = "smtp.sina.com"
EMAIL_PORT = 25
EMAIL_HOST_USER = 'myoak_notify@sina.com'
EMAIL_HOST_PASSWORD = 'sunzhe920923'
EMAIL_USE_TLS = True
